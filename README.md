...
in all four ways a reader can arrive** · self-hosted fonts, no CDN dependency ·
the light register — genuinely warm ivory, cream and parchment with a gilt band, lapis and
gold · dark and light themes · full RTL · **a fourteen-component design canon**, every page
composed from it, identically in both languages.

**Editorial Bible RATIFIED and IN FORCE (v0.9). Building continuously — deploy, review,
improve, repeat.**
...
| [`docs/11-shrs-feature-register.md`](docs/11-shrs-feature-register.md) | **The complete feature study of shroyalschools.com** — 148 pages, 74 client modules, 40+ backend functions, inventoried feature by feature with a decision and a reason for each: **build, adapt, gated, or rejected**. Six built in this pass; twenty-two gated on a fact only the Founder can supply, each with its trigger; seven rejected on a ratified principle. Cited as `FR-n`. |
...
|---|---|---|
| 1 | **Editorial Bible** | ✅ **Ratified** — v0.9, in force |
