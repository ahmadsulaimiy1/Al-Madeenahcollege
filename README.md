...
20 pages · **1,630 static checks + 370 rendered-browser checks** including computed WCAG contrast on six light grounds,
...
npm test           # build + 1,630 static checks + 370 rendered-browser checks
